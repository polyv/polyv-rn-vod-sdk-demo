...
public class PolyvPlayerMediaControllerRN extends PolyvBaseMediaController implements View.OnClickListener {
    private static final String TAG = PolyvPlayerMediaControllerRN.class.getSimpleName();
...
//    private PolyvPlayerDanmuLayout danmuFragment;
    ...
    private volatile  static boolean hasVideoLandscape;//是否已经有视频全屏
    ...
    public PolyvPlayerMediaControllerRN(Context context) {
        this(context, null);
    }

    public PolyvPlayerMediaControllerRN(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PolyvPlayerMediaControllerRN(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    public void setDanmuFragment(PolyvPlayerDanmuLayout danmuFragment) {
...
//                danmuFragment.resume();
    ...
    SeekBar.OnSeekBarChangeListener seekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
            ...
            if (i1 == R.id.sb_play || i1 == R.id.sb_play_land) {
                resetHideTime(longTime);
            ...
            } else if (i1 == R.id.sb_light) {
                if (videoView != null)
                    videoView.setBrightness(videoActivity, i);

            } else if (i1 == R.id.sb_volume) {
                if (videoView != null)
...
//        danmuFragment.send(videoView, et_dmedit.getText().toString(), fontmode, fontsize, color);
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.iv_port) {
            changeToPortrait();

        } else if (i == R.id.iv_play) {
            playOrPause();

        } else if (i == R.id.iv_play_land) {
            playOrPause();
...
//                resetDmSwitchView();
//                break;
        } else if (i == R.id.tv_srt1) {
            resetSrtView(0);

        } else if (i == R.id.tv_srt2) {
            resetSrtView(1);

        } else if (i == R.id.tv_srt3) {
            resetSrtView(2);

        } else if (i == R.id.tv_srtnone) {
            resetSrtView(3);
        ...
        } else if (i == R.id.tv_auto) {
            resetBitRateView(0);

        } else if (i == R.id.tv_speed05) {
            resetSpeedView(5);

        } else if (i == R.id.tv_speed10) {
            resetSpeedView(10);

        } else if (i == R.id.tv_speed12) {
            resetSpeedView(12);

        } else if (i == R.id.tv_speed15) {
            resetSpeedView(15);

        } else if (i == R.id.tv_speed20) {
            resetSpeedView(20);

        } else if (i == R.id.iv_close_bit) {
            hide();

        } else if (i == R.id.iv_close_set) {
            hide();

        } else if (i == R.id.iv_close_share) {
            hide();

        } else if (i == R.id.iv_close_speed) {
            hide();

        } else if (i == R.id.tv_dmsend) {
            sendDanmaku();

        } else if (i == R.id.iv_screens) {
            screenshot();

        } else if (i == R.id.iv_video || i == R.id.iv_video_land) {//如果当前已经是优先视频模式，则不再切换
        ...
        } else if (i == R.id.iv_audio || i == R.id.iv_audio_land) {//如果当前已经是优先音频模式，则不再切换
...
//            sb_play.setEnabled(enabled);
        ...
        if (sb_play_land != null)
            sb_play_land.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    return !enabled;
                }
            });
//            sb_play_land.setEnabled(enabled);
    }
}
