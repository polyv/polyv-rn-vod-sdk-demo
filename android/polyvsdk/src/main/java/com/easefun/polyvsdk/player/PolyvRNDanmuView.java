...
public class PolyvRNDanmuView extends FrameLayout {
    public PolyvRNDanmuView(@NonNull Context context) {
        this(context,null);
    }

    public PolyvRNDanmuView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public PolyvRNDanmuView(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        View.inflate(context, R.layout.polyv_fragment_player_danmu, this);
        findIdAndNew();
        initView();
    }
