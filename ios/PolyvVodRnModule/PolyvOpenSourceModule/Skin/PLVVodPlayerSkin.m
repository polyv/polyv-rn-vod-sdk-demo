...
/// 锁屏状态
@property (assign, nonatomic) BOOL isChangingScreen;
...
- (void)interfaceOrientationDidChange:(NSNotification *)notification {
  ...
  if (!self.isChangingScreen) {
    return;
  }
  self.isChangingScreen = NO;
...
//    }
  ...
  [self.wrapperView switchToFullScreen:fullScreen];
}
